  ...
  const mockItems = [
    {
      ...
      unidades_por_bulto: null, precio_unitario_costo: 423.5,
      validacion_subtotal: 'ok', notas_calculo: '+IVA 21% = $423.5000/u final',
      productos: { nombre: 'Coca Cola 500ml', sku: 'CC500' },
    },
    {
      id: 'item-2', factura_id: 'f-1', descripcion_original: 'FANTA UVA 12X500',
      producto_id: null, alias_usado: null, cantidad: 2, unidad: 'un',
      precio_unitario: 3840, subtotal: 7680, estado_match: 'fuzzy_pendiente',
      confianza_match: 0.4, created_at: '2026-02-20T10:00:01Z',
      unidades_por_bulto: 12, precio_unitario_costo: 387.2,
      validacion_subtotal: 'ok', notas_calculo: 'Pack 12u | $3840/12 = $320.0000/u neto | +IVA 21% = $387.2000/u final',
      productos: null,
    },
  ]
