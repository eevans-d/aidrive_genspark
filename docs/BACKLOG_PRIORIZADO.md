...
| P0-04 | Validacion de rol server-side (no metadata) | 5 | 3 | 4 | 6.7 | Tabla roles | Backend/DB | ✅ Completado (roles via `app_metadata`, sin fallback a `user_metadata`) |
...
| P1-05 | Capa de datos con caching (React Query/SWR) | 4 | 3 | 3 | 4.0 | N/A | Frontend | ✅ VERIFICADO (2026-01-18, 8/8 páginas con data usan hooks React Query; Login no aplica) |
