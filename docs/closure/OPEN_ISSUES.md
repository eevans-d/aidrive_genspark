...
| Verificar sender real en SendGrid (From Email SMTP Auth) | P1 | `docs/SENDGRID_VERIFICATION.md` | Fix de codigo aplicado (PR #53): `cron-notifications` ahora lee `SMTP_FROM`. Falta redeploy + verificacion de sender en SendGrid Dashboard. | PARCIAL 2026-02-09 (fix code; pendiente redeploy + sender verification) |
