...
|-----------|-----------|-----------|------|-------------|
| Habilitar leaked password protection (Auth) requiere SMTP personalizado | P0 | `docs/ESTADO_ACTUAL.md` | Configurar SMTP (SendGrid API key + email verificado) y activar toggle en panel | PENDIENTE |
