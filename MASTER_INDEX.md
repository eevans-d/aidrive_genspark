...
✅ Test Coverage         : 85.74% (line coverage from coverage.xml)
✅ Uptime Monitored      : Baseline being collected
...
- ✅ 85.74% line coverage (verified from coverage.xml)
- ✅ Uptime monitoring in progress (baseline being collected)
